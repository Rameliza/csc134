...
int main() {
    //setup
    string movie_name = "Brown Sugar";
    string director = "Rick Famuyiwa";
    int year = 2002;
    double box_office = 28.3;        // million $

    // output
    cout << "The movie " << movie_name << " came out in " << year << "." << endl;
    cout << "The director was " << director << "." << endl;
    cout << "Box office was $" << box_office << " million USD." << endl;

    cout << " When did you fall in love with hip hop scene" << endl;
